...
class Issue extends \yii\db\ActiveRecord
{
	...
	{
		$subquery = IssueStatus::find()->select('MAX(id)')->groupBy('issue_id');
		return $this->hasOne(IssueStatus::className(), ['issue_id' => 'id'])->andWhere([IssueStatus::tableName() . '.id' => $subquery]);
	}
