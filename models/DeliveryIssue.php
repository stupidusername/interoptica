...
class DeliveryIssue extends \yii\db\ActiveRecord
{
	...
	public function afterSave($insert, $changedAttributes) {
		if ($insert) {
			$this->issue->status = IssueStatus::STATUS_WAITING_FOR_TRANSPORT;
			$this->issue->save();
		}
	...
	public function rules()
	{
		return [
			...
			[['issue_id'], 'unique', 'when' => function() { return count(self::find()->andWhere(['issue_id' => $this->issue_id])->innerJoinWith('delivery')); }],
